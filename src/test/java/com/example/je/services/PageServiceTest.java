...
class PageServiceTest {
    ...
    void addFilms() {
        ...
        mainFilms.add(new Film(1L, "1", "1", "1", "1", new ArrayList<>(), new ArrayList<>(), "1", 11L, "1", "1", true, false));
        mainFilms.add(new Film(2L, "2", "2", "2", "2", new ArrayList<>(), new ArrayList<>(), "2", 22L, "2", "2", true, false));
        newFilms.add(new Film(3L, "3", "3", "3", "3", new ArrayList<>(), new ArrayList<>(), "3", 33L, "3", "3", true, false));
        newFilms.add(new Film(4L, "4", "4", "4", "4", new ArrayList<>(), new ArrayList<>(), "4", 44L, "4", "4", true, false));
