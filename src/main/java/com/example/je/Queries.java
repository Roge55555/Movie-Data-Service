...
public class Queries {
    ...
    public static final String INSERT_FILM = "insert into film(id, name_ru, name_en, year, length, rating, rating_vote_count, poster_url, poster_url_preview) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public static final String UPDATE_COUNTRY_IN_FILM = "insert into film_country(film_id, country_id) values (?, (select id from country where name = ?))";
    public static final String UPDATE_GENRE_IN_FILM = "insert into film_genre(film_id, genre_id) values (?, (select id from genre where name = ?))";
